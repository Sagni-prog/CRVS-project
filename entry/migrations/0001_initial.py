# Generated by Django 4.0.6 on 2023-01-29 20:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(null=True)),
                ('admin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('birth_date', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='birth', to='entry.sessionyearmodel')),
                ('death_date', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='death', to='entry.sessionyearmodel')),
                ('kebele', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='entry.kebele')),
            ],
            options={
