...
urlpatterns = [
    ...
    path('edit_employee/<employee_id>/', systemadmin.edit_employee, name="edit_employee"),
    ...
    path('edit_kebele_save/', systemadmin.edit_kebele_save, name="edit_course_save"),
    ...
    path('edit_resident/<resident_id>', systemadmin.edit_resident, name="edit_risedent"),
